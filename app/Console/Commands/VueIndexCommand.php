...
class VueIndexCommand extends GeneratorCommand
{
    /**
    ...
    {
        return __DIR__ . '/../stubs/vue-index.stub';
    }
    ...
    protected function replaceNamespace(&$stub, $name)
    {
        ...
        $ex =  explode(".", $name);
        $stub = str_replace('{Component}', strtolower($ex[0]), $stub);
